...
import shotbot.util.PortReader;
 ...
 *
 * Look inside Shotbot.java for the actual bot logic!
 */
public class BotMain {
    ...
    public static void main(String[] args) {
        ...
        BotInterface pythonInterface = new BotInterface(port, botManager);
    ...
    private static void displayWindow(BotManager botManager, int port) {
        ...
        URL url = BotMain.class.getClassLoader().getResource("icon.png");
